...
function page() {
  ...
  // Calculate token count for selected content
  const currentPromptContent = useMemo(() => {
    if (!selectedItems.length) return ''
    return generatePrompt()
  }, [selectedItems, repoContent])

  return (
    <div className='min-h-screen bg-[#121212] flex flex-col items-center justify-center px-10' id='playground'>
      <div className='flex items-center justify-center h-[650px] outline-2 outline-white/15 outline-offset-4 rounded-2xl w-full max-w-[1400px] overflow-hidden relative'>
              ...
              <div className='flex items-start justify-between px-10 py-2'>
                <div className='flex gap-1'>
                  <button
                    ...
                    className={` text-white/60 disabled:opacity-60 bg-[#2e2e2e] rounded-l-4xl rounded-r-sm h-10 w-[42px] lg:w-[148px] pl-1 lg:pl-0 font-medium text-sm flex items-center justify-center gap-2`}
                  >
                  ...
                  <button
                    ...
                    className={` text-white/60 disabled:opacity-60 bg-[#2e2e2e] rounded-r-4xl rounded-l-sm h-10 w-[42px] lg:w-[148px] pr-1 lg:pr-0 font-medium text-sm flex items-center justify-center gap-2`}
                  >
                    {fetchingContent ? (
                      <svg className="animate-spin h-5 w-5" viewBox="0 0 24 24">
                        <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" fill="none" />
