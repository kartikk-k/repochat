...
function page() {
  ...
  const handleCopyContent = () => {
    ...
    toast.custom((t) => (
      <div className={`${t} flex flex-col bg-app-success-bg text-app-success font-medium rounded-xl px-4 justify-center h-[64px] min-w-[250px] outline outline-app-success/20 outline-offset-4`}>
        <p>Prompt copied</p>
  ...
  return (
    <div className='min-h-screen bg-app-bg flex flex-col items-center justify-center px-10'>
      <div className='flex items-center justify-center h-[650px] outline-2 outline-app-border outline-offset-4 rounded-2xl w-full max-w-[1200px] overflow-hidden relative'>
        {/* sidebar */}
        <div className='w-[280px] bg-app-sidebar h-full rounded-l-2xl relative'>
          ...
          <div className='flex items-center justify-between absolute top-4 left-4 right-4'>
            <div className='flex items-center gap-2'>
              <span className='h-3 w-3 rounded-full border border-app-border' />
              <span className='h-3 w-3 rounded-full border border-app-border' />
              <span className='h-3 w-3 rounded-full border border-app-border' />
            </div>
            <ThemeToggle />
        ...
        {/* main */}
        <div className='flex-1 bg-app-main h-full rounded-r-2xl relative'>
          <div className='flex items-center justify-center w-full p-10'>
            <div className='flex items-center gap-1 w-full rounded-full outline outline-app-border outline-offset-4 focus-within:outline-2 focus-within:outline-app-border/60 transition-all duration-300'>
              <input
                type="text"
                ...
                className='bg-app-input text-app-text text-sm font-medium w-full h-11 outline-none rounded-l-full px-5 placeholder:text-app-text-muted'
              />
              ...
              <div className='flex items-center gap-1'>
                <button
                  ...
                  onClick={handleFetch}
                  disabled={isLoading}
                  className={`text-app-success bg-app-success-bg font-semibold text-sm outline-none w-28 h-11 flex items-center justify-center gap-2 ${isLoading ? 'opacity-50 cursor-not-allowed' : 'hover:bg-app-success-bg/80'} transition-colors`}
                >
                  {isLoading ? (
                    ...
                    <>
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"><title>plug-2</title><g fill="currentColor"> <path fillRule="evenodd" clipRule="evenodd" d="M5.35528 8.46328C4.67183 7.77848 3.56372 7.77958 2.88033 8.46298C1.04246 10.3009 1.04178 13.2824 2.87967 15.1203C4.71756 16.9582 7.69841 16.9582 9.53631 15.1203C10.2211 14.4369 10.2204 13.3284 9.53699 12.645L5.35528 8.46328Z"></path> <path fillRule="evenodd" clipRule="evenodd" d="M16.7803 1.21967C17.0732 1.51256 17.0732 1.98744 16.7803 2.28033L15.6086 3.45203C16.9405 5.29199 16.7777 7.87891 15.1203 9.53631C14.4322 10.1368 13.3829 10.1082 12.7283 9.45365L8.54706 5.27232C7.89086 4.61741 7.86338 3.56763 8.4637 2.87964C10.1211 1.22223 12.708 1.05947 14.548 2.39136L15.7197 1.21967C16.0126 0.926777 16.4874 0.926777 16.7803 1.21967Z" fillOpacity="0.4"></path> <path d="M2.39136 14.548C2.53639 14.7483 2.69915 14.9398 2.87963 15.1203C3.06013 15.3008 3.25165 15.4636 3.45202 15.6086L2.28033 16.7803C1.98744 17.0732 1.51256 17.0732 1.21967 16.7803C0.926777 16.4874 0.926777 16.0126 1.21967 15.7197L2.39136 14.548Z"></path> <path d="M9.22631 12.3343L8.16565 11.2737L9.46962 9.96967C9.76251 9.67678 10.2374 9.67678 10.5303 9.96967C10.8232 10.2626 10.8232 10.7374 10.5303 11.0303L9.22631 12.3343Z"></path> <path d="M8.0303 7.46967C8.32319 7.76257 8.32319 8.23744 8.03029 8.53033L6.72631 9.83434L5.66565 8.77368L6.96964 7.46967C7.26253 7.17678 7.73741 7.17678 8.0303 7.46967Z"></path> </g></svg>
                      Fetch
                    </>
                  )}
                </button>
                <button
                  ...
                  className='text-app-success bg-app-success-bg px-4 flex items-center justify-center font-semibold text-sm outline-none h-11 rounded-r-full gap-2 hover:bg-app-success-bg/80 transition-colors'
                >
          ...
          {error && (
            <div className="px-10 text-destructive text-sm">
              {error}
            </div>
          )}
          ...
          <div className='absolute bottom-0 left-0 right-0 flex items-start justify-between px-10 py-2 bg-app-main'>

            <div className='flex gap-1'>
              <button
                onClick={handlePreview}
                disabled={!selectedItems.length}
                className={`text-app-text-muted disabled:opacity-60 bg-app-input rounded-l-4xl rounded-r-sm h-10 w-[148px] font-medium text-sm flex items-center justify-center gap-2 transition-all duration-300 hover:bg-app-hover`}
              >
              ...
              <button
                ...
                disabled={!selectedItems.length}
                className={`text-app-text-muted disabled:opacity-60 bg-app-input rounded-r-4xl rounded-l-sm h-10 w-[148px] font-medium text-sm flex items-center justify-center gap-2 transition-all duration-300 hover:bg-app-hover`}
              >
                {fetchingContent ? (
                  <svg className="animate-spin h-5 w-5" viewBox="0 0 24 24">
                    <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" fill="none" />
                  ...
                  <>
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"><title>clone</title><g fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" stroke="currentColor"><path d="M10.75 1.75H3.75C2.64543 1.75 1.75 2.64543 1.75 3.75V10.75C1.75 11.8546 2.64543 12.75 3.75 12.75H10.75C11.8546 12.75 12.75 11.8546 12.75 10.75V3.75C12.75 2.64543 11.8546 1.75 10.75 1.75Z" fill="currentColor" fillOpacity="0.3" data-stroke="none" stroke="none"></path> <path d="M10.75 1.75H3.75C2.64543 1.75 1.75 2.64543 1.75 3.75V10.75C1.75 11.8546 2.64543 12.75 3.75 12.75H10.75C11.8546 12.75 12.75 11.8546 12.75 10.75V3.75C12.75 2.64543 11.8546 1.75 10.75 1.75Z"></path> <path d="M15 5.39499C15.733 5.69199 16.25 6.40999 16.25 7.24999V14.25C16.25 15.355 15.355 16.25 14.25 16.25H7.25002C6.41102 16.25 5.69202 15.733 5.39502 15"></path></g></svg>
                    Copy content
                  </>
                )}
              </button>
            ...
            <div className='flex flex-col items-center'>
              <div className='flex items-center gap-1'>
                <button
                  ...
                  className={`${useAuthToken ? 'bg-app-success-bg text-app-success' : 'bg-app-input text-app-text-muted'} rounded-l-full h-10 px-4 font-medium text-sm flex items-center gap-2 transition-all duration-300 hover:opacity-80`}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"><title>user-key</title><g fill="currentColor"><path d="M9 7.00049C10.6571 7.00049 12 5.65736 12 4.00049C12 2.34362 10.6571 1.00049 9 1.00049C7.34291 1.00049 6 2.34362 6 4.00049C6 5.65736 7.34291 7.00049 9 7.00049Z" fillOpacity="0.4"></path> <path fillRule="evenodd" clipRule="evenodd" d="M8.5 14.25C8.5 12.7312 9.73119 11.5 11.25 11.5C12.5088 11.5 13.57 12.3457 13.8965 13.5H17.25C17.6642 13.5 18 13.8358 18 14.25C18 14.6642 17.6642 15 17.25 15H16.5V15.75C16.5 16.1642 16.1642 16.5 15.75 16.5C15.3358 16.5 15 16.1642 15 15.75V15H13.8965C13.57 16.1543 12.5088 17 11.25 17C9.73119 17 8.5 15.7688 8.5 14.25ZM11.25 13C10.5596 13 10 13.5596 10 14.25C10 14.9404 10.5596 15.5 11.25 15.5C11.9404 15.5 12.5 14.9404 12.5 14.25C12.5 13.5596 11.9404 13 11.25 13Z"></path> <path d="M8.99999 8.50049C6.14167 8.50049 3.69058 10.2162 2.60517 12.6679C2.05162 13.9191 2.74425 15.3322 4.01259 15.7318C4.98685 16.0388 6.20082 16.323 7.60804 16.4418C7.22206 15.8019 7 15.0519 7 14.25C7 11.9028 8.90275 10 11.25 10C11.8742 10 12.4665 10.1344 13 10.3758V9.75882C11.8675 8.9661 10.489 8.50049 8.99999 8.50049Z" fillOpacity="0.4"></path></g></svg>
                  Use Token
                </button>
                <button
                  onClick={() => setIsDialogOpen(true)}
                  className={`${useAuthToken ? 'bg-app-success-bg text-app-success' : 'bg-app-input text-app-text-muted'} rounded-r-full h-10 px-4 font-semibold text-sm transition-all duration-300 hover:opacity-80`}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"><title>dots</title><g fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" stroke="currentColor"><path d="M9 9.5C9.27614 9.5 9.5 9.27614 9.5 9C9.5 8.72386 9.27614 8.5 9 8.5C8.72386 8.5 8.5 8.72386 8.5 9C8.5 9.27614 8.72386 9.5 9 9.5Z" fill="currentColor"></path> <path d="M3.25 9.5C3.52614 9.5 3.75 9.27614 3.75 9C3.75 8.72386 3.52614 8.5 3.25 8.5C2.97386 8.5 2.75 8.72386 2.75 9C2.75 9.27614 2.97386 9.5 3.25 9.5Z" fill="currentColor"></path> <path d="M14.75 9.5C15.0261 9.5 15.25 9.27614 15.25 9C15.25 8.72386 15.0261 8.5 14.75 8.5C14.4739 8.5 14.25 8.72386 14.25 9C14.25 9.27614 14.4739 9.5 14.75 9.5Z" fill="currentColor"></path></g></svg>
                </button>
              </div>
              <span className='text-app-text-muted text-xs mt-1'>Click to toggle</span>
            </div>
          </div>
